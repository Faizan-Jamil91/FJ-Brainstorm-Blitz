    ...
    if st.session_state.mcqs:
        ...
        if st.button("Generate Result"):
            ...
            with st.spinner('Generating Result...'):
                ...
                input_string2 = f"Match the answers provided by the result answer option{collected_answers_df}, is equal to the {result} collected answer option, and calculate the correct and incorrect answer if no answer match with the date its mean that all answers are incorrect"
