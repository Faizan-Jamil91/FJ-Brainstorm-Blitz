    ...
    if st.session_state.mcqs:
        ...
        if st.button("Generate Result"):
            ...
            with st.spinner('Generating Result...'):
                ...
                input_string2 = f"Match the answers provided by the result answer option{result}, is equal to the {collected_answers_df} collected answer option, and calculate the correct and incorrect answer if no answer match with the date its mean that all answers are incorrect"
